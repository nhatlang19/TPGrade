...
public class RectangleProcessor {
    ...
    public RectangleProcessor(RectanglePointInterface rectanglePoint) {
    ...
    public synchronized Mat puzzleFrame(Mat inputPicture, Mat inputPictureGray) {
        ...
        listDetectRectangle.add(new DetectRectangle(1, r0t, r0gt));
        ...
        listDetectRectangle.add(new DetectRectangle(2, r1t, r1gt));
        ...
        listDetectRectangle.add(new DetectRectangle(3, r2t, r2gt));
        ...
        listDetectRectangle.add(new DetectRectangle(4, r3t, r3gt));
